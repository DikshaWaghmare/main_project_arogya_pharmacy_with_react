    ...
    return (
        <div className="border" style={{ backgroundColor: "darkseagreen", height: "100vh" }}>
            ...
            <div className="container" style={{ marginLeft: "500px" }}>
                <form className="p-4 rounded  mt-3 border" onSubmit={order} style={{ height: "auto", width: "500px", boxShadow: "0px 0px 5px greenyellow" }}>
                <div className="row mb-3">
                        <label className="col-sm-4 col-form-label">Customer Email:</label>
                        <div className="col-sm-8">
                            <input type="text" id="custEmail" className="form-control" onChange={(e) => setcustomerEmail(e.target.value)} onKeyDown={cleanOrderMsg} />
                        </div>
                    </div>
                    <div className="row mb-3">
                        <label className="col-sm-4 col-form-label">Category Id:</label>
                        <div className="col-sm-8">
                            <input type="number" id="cid" className="form-control" onChange={(e) => setcategoryId(e.target.value)} onKeyDown={cleanOrderMsg} />
                        </div>
                    </div>
                    <div className="row mb-3">
                        <label className="col-sm-4 col-form-label">Product Id:</label>
                        <div className="col-sm-8">
                            <input type="number" id="pid" className="form-control" onChange={(e) => setproductId(e.target.value)} onKeyDown={cleanOrderMsg} />
                        </div>
                    </div>
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col-sm-8">
                            <input type="number" id="qty" className="form-control" onChange={(e) => setproductqty(e.target.value)} onKeyDown={cleanOrderMsg} />
                        </div>
                    </div>
                    <div className="text-center">
                        <input type="submit" value="Order" className="m-3 btn btn-outline-dark" />
                        <input type="reset" value="Cancel" className="m-3 btn btn-outline-dark" /><br /><br />
                    </div>
                    <span id="order"></span>
                </form>
