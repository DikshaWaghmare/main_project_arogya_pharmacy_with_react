...
function AddSalesman() {
    ...
    return (
        <div style={{ backgroundColor: "darkseagreen", height: "100vh" }}>
            ...
            <form className=" p-5 border mx-auto" onSubmit={addProduct}
                ...
                <div className="row mb-3">
                    ...
                    <div className="col-sm-8">
                        <input type="number" id="sid" className="form-control" onChange={(e) => setId(e.target.value)} onKeyDown={cleansmsg} />
                    </div>
                </div>
                <div className="row mb-3">
                    <label className="col-sm-4 col-form-label">Enter Full Name</label>
                    <div className="col-sm-8">
                        <input type="text" id="sname" className="form-control" onChange={(e) => setName(e.target.value)} onKeyDown={cleansmsg} />
                    </div>
                </div>
                <div className="row mb-3">
                    <label className="col-sm-4 col-form-label">Email</label>
                    <div className="col-sm-8">
                        <input type="email" className="form-control" id="semail" onChange={(e) => setEmail(e.target.value)} onKeyDown={cleansmsg} />
                    </div>
                </div>
                ...
                <div className="row mb-3">
                    ...
                    <div className="col-sm-3">
                        <input type="number" className="form-control" id="age" onChange={(e) => setAge(e.target.value)} onKeyDown={cleansmsg} />
                    </div>
                    <label className="col-sm-3 col-form-label">Mobile No.:</label>
                    <div className="col-sm-4">
                        <input type="number" className="form-control" id="mobileno" onChange={(e) => setMobileNo(e.target.value)} onKeyDown={cleansmsg} />
                    </div>
                </div>
                <div className="row mb-3">
                    <label className="col-sm-3 col-form-label">Address</label>
                    <div className="col-sm-9">
                        <input type="text" className="form-control" id="address" onChange={(e) => setAddress(e.target.value)} onKeyDown={cleansmsg} />
                    </div>
                </div>
                ...
                <input type="reset" value="cancel" className="ms-5 mt-3 fs-5 px-4"
